...
NOTFOUND["❌ Error:<br>Install with brew"]
LOADENV["🔑 Load .env<br>SONAR_TOKEN"]
ENVWARN[".env<br>exists?"]
WARN["⚠️ Warning:<br>Set SONAR_TOKEN manually"]
COVERAGE["📊 npm run test:coverage<br>Generate lcov.info"]
COVCHECK["Coverage<br>succeeded?"]
COVWARN["⚠️ Warning:<br>Coverage failed, continuing"]
SCAN["🔍 sonar-scanner<br>Analyze code"]
SCANCHECK["Analysis<br>succeeded?"]
SUCCESS["✅ Analysis complete"]
FAIL["❌ Analysis failed<br>Exit 1"]
